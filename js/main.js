...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>HOW TO PLAY</div><p>The goal of Hextris is to stop blocks from leaving the inside of the outer gray hexagon.</p><p>" + (settings.platform != 'mobile' ? '' : 'Tap the left and right sides of the screen') + " to rotate the Hexagon." + (settings.platform != 'mobile' ? ' ': '') + " </p><p>Clear blocks and get points by making 3 or more blocks of the same color touch.</p><p>Time left before your combo streak disappears is indicated by <span style=';'>the</span> <span style=''>colored</span> <span style=''>lines</span> <span style=''>on</span> the outer hexagon</p> <hr> <p id = 'afterhr'></p> By <a href='' target='_blank'>MyCompanyname</a><a href='' target='_blank'></a><br> <a href = '' target='_blank'></a><a href ='' target='_blank'></a><br><a href ='' target='_blank'></a>");
	if (gameState == 1) {
		pause();
	}
